...
def CHARGEBACK2(request,files1):
    move_files = []
    ...
    with open(r"E:\IWOC\SOURCE\TL-191022.txt") as f:
        for line in f:
    ...
    file=open(r"E:\\IWOC\\LOG_FILES\\chargeback2.txt","a")
    ...
    for i in range(0,Total_lines):
        pdf.add_page()
        pdf.image(r'E:\IWOC\APP SCRIPT\CHARGEBACK2\CYCLE\CHARGEBACK2\DATA\MiB-02.jpg',30,15,50)
        ...
        # pdf.image('E:\IWOC\SOURCE\MiB-03.jpg', 20, 260 , 15)        
        ...
        pdf.add_page()
        pdf.image(r'E:\IWOC\APP SCRIPT\CHARGEBACK2\CYCLE\CHARGEBACK2\DATA\MiB-01.jpg',5, 10,200)
        pdf.ln(1)
    ...
    pdf.output(r'E:\IWOC\APP SCRIPT\CHARGEBACK2\CYCLE\CHARGEBACK2\DATA\MBB001_TL.pdf')
    time1 = datetime.now()
    ...
    pdf_in = open(r'E:\IWOC\APP SCRIPT\CHARGEBACK2\CYCLE\CHARGEBACK2\DATA\MBB001_TL.pdf', 'rb')
    ...
    pdf_out = open(r'E:\IWOC\OUTPUT\CHARGE BACK\ALL\MBB001_TL.pdf', 'wb')
    ...
    import os
    base_filename = r'E:\IWOC\OUTPUT\CHARGE BACK\ALL\maybank_Acc_TL.txt'
    ...
    import os
    base_filename = r'E:\IWOC\OUTPUT\CHARGE BACK\ALL\mapping_file_TL.txt'
    with open(os.path.join(base_filename),'w') as outfile:
