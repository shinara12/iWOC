...
def REMINDER1(request,files1):
    ...
    for i in range(0,Total_accounts):
        ...
        pdf.image(r'E:\IWOC\APP SCRIPT\REMINDER1\CYCLE\REMINDER1\DATA\BSN_Reminder-02 - Copy.jpg', 145,146,45)

        pdf.ln(1)
        new_code  = 'b' + str(count)
        pdf.image(r'E:\IWOC\EXTRA\barcode_for_rem1\%s.png'%(new_code),32,214,40)  # 70
        ...
        pdf.cell(5)
        pdf.cell(10,419,txt = '(' + str(postcode[i])+  ')' + '-P0 1-01')
        count = int(count)
        count += 1
