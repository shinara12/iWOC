...
def TAX_INV(request,files1):
    ...
    def barcode(acc_no,count):
        ...
        my_code.save(r"E:\IWOC\EXTRA\barcode_for_tax\%s" %(new_code))

        from PIL import Image

        img = Image.open(r"E:\IWOC\EXTRA\barcode_for_tax\%s.png" %(new_code))
        imgCropped = img.crop(box=(4,10,1080,200))
        imgCropped.save(r"E:\IWOC\EXTRA\barcode_for_tax\%s.png" %(new_code))
    ...
    for i in range(0,number_of_rows):
        ...
        pdf.cell(10,498,txt= 'TaxInv231122-241122.csv-00000' + str(count))
        ...
        pdf.ln(1)
        new_code  = 'b' + str(count)
        pdf.image(r'E:\IWOC\EXTRA\barcode_for_tax\%s.png'%(new_code),32,212,40)
