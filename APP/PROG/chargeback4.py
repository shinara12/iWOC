...
def CHARGEBACK4(request,files1):
    move_files = []
    ...
    file=open(r"E:\\IWOC\\LOG_FILES\\chargeback4.txt","a")
    ...
    for i in range(0,Total_lines):
        pdf.add_page()
        pdf.image(r'E:\IWOC\APP SCRIPT\CHARGEBACK4\CYCLE\CHARGEBACK4\DATA\MiB-02.jpg',30,15,50)
        ...
        pdf.add_page()
        pdf.image(r'E:\IWOC\APP SCRIPT\CHARGEBACK4\CYCLE\CHARGEBACK4\DATA\MiB-01.jpg',5, 10,200)
        pdf.ln(1)
    ...
    pdf.output(r'E:\IWOC\APP SCRIPT\CHARGEBACK4\CYCLE\CHARGEBACK4\DATA\MBB001_TF.pdf')
    time1 = datetime.now()
    ...
    pdf_in = open(r'E:\IWOC\APP SCRIPT\CHARGEBACK4\CYCLE\CHARGEBACK4\DATA\MBB001_TF.pdf', 'rb')
    ...
    pdf_out = open(r'E:\IWOC\OUTPUT\CHARGE BACK\ALL\MBB001_TF.pdf', 'wb')
    ...
    import os
    base_filename = r'E:\IWOC\OUTPUT\CHARGE BACK\ALL\maybank_Acc_TF.txt'
    ...
    import os
    base_filename = r'E:\IWOC\OUTPUT\CHARGE BACK\ALL\mapping_file_TF.txt'
    with open(os.path.join(base_filename),'w') as outfile:
