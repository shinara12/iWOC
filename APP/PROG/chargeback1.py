...
def CHARGEBACK1(request,files1):
    move_files = []
    ...
    file=open(r"E:\\IWOC\\LOG_FILES\\chargeback1.txt","a")
    ...
    for i in range(0,Total_lines):
        pdf.add_page()
        pdf.image(r'E:\IWOC\APP SCRIPT\CHARGEBACK1\CYCLE\CHARGEBACK1\DATA\MiB-02.jpg',30,15,50)
        ...
        pdf.image(r'E:\IWOC\APP SCRIPT\CHARGEBACK1\CYCLE\CHARGEBACK1\DATA\MiB-03.jpg', 20, 260 , 15)        
    ...
    # date to be mentioned here 
        ...
        pdf.add_page()
        pdf.image(r'E:\IWOC\APP SCRIPT\CHARGEBACK1\CYCLE\CHARGEBACK1\DATA\MiB-01.jpg',5, 10,200)
        pdf.ln(1)
    ...
    pdf.output(r'E:\IWOC\APP SCRIPT\CHARGEBACK1\CYCLE\CHARGEBACK1\DATA\MBB00_ASBI.pdf')
    time1 = datetime.now()
    ...
    pdf_in = open(r'E:\IWOC\APP SCRIPT\CHARGEBACK1\CYCLE\CHARGEBACK1\DATA\MBB00_ASBI.pdf', 'rb')
    ...
    pdf_out = open(r'E:\IWOC\OUTPUT\CHARGE BACK\ALL\MBB00_ASBI.pdf', 'wb')
    ...
    import os
    base_filename = r'E:\IWOC\OUTPUT\CHARGE BACK\ALL\maybank_Acc_asbi.txt'
    ...
    import os
    base_filename = r'E:\IWOC\OUTPUT\CHARGE BACK\ALL\mapping_file_asbi.txt'
    with open(os.path.join(base_filename),'w') as outfile:
