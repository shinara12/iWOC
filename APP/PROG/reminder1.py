...
def REMINDER1(request,files1):
    ...
    file=open(r"E:\\IWOC\\LOG_FILES\\reminder1.txt","a")
    ...
    def barcode(acc_no,count):
        ...
        my_code.save(r"E:\IWOC\barcode_for_rem1\%s" %(new_code))

        from PIL import Image

        img = Image.open(r"E:\IWOC\barcode_for_rem1\%s.png" %(new_code))
        imgCropped = img.crop(box=(4,10,1080,200))
        imgCropped.save(r"E:\IWOC\barcode_for_rem1\%s.png" %(new_code))
        # imgCropped.show()
    ...
    for i in range(0,Total_accounts):
        ...
        pdf.cell(80)
        pdf.cell(10,220, txt = str(df['ICBS_PROD_SUBDESC'][i]))
        ...
        if n > 7:
            ...
            pdf.cell(10,276,txt = 'RM ' + str(df['TOTAL_DUE'][i]))
        ...
        c += 1
        pdf.ln(1)
        pdf.image(r'E:\IWOC\APP SCRIPT\REMINDER1\CYCLE\REMINDER1\DATA\BSN_Reminder-02.jpg', 12,154,180)

        pdf.ln(1)
        new_code  = 'b' + str(count)
        pdf.image(r'E:\IWOC\barcode_for_rem1\%s.png'%(new_code),30,203,70)
        

        #--------------------------------image crop-------------------------------------
        # img = Image.open(r"C:\Users\Lenovo\Desktop\REMINDER\barcod_fo\b1.png")
        # img = Image.open(r"C:\Users\Lenovo\Desktop\REMINDER\barcod_fo\%s.png" %(new_code))
        # img = img.crop((10, 5, 1150, 200)).resize((500, 96), resample=Image.NEAREST)
        # pdf.image(img,x =80, y =100)
        # img.save('b120.png')
        # pdf.image(r'C:\Users\Lenovo\Desktop\REMINDER\barcod_fo\b12.png',40,210,60)
        ...
        pdf.cell(10,410, txt  = str(count_value))
        pdf.cell(-2)
        pdf.cell(10,410, txt = "-" + str(date2[i]))
        pdf.cell(5)
        pdf.cell(10,410,txt = '(000)-P0 1-01')
        count = int(count)
        count += 1
    ...
    # pdf.output(r'E:\IWOC\APP SCRIPT\REMINDER1\CYCLE\REMINDER1\DATA\rem1.pdf')
    time1 = datetime.now()
